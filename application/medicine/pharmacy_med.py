...
def edit_medicine_combined(id):
    if request.method == "POST":
        ...
        try:
            ...
            if stock_quantity or batch_number or expiry_date or purchase_price or selling_price:
            ...
            if ratelist_amount or quantity_per_pack or discount or cgst or sgst:
